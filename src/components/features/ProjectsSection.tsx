  ...
  const projects = [
    {
      ...
      description:
        'Full-stack e-commerce application built with React frontend and Spring Boot backend, featuring user authentication, product management, and payment integration.',
    ...
    },
    {
      ...
      description:
        'Data visualization dashboard that aggregates weather data from multiple APIs and provides interactive charts and forecasting.',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            ...
            skills in full-stack development. These projects are templates and
            are ready for integration, demonstrating my ability to deliver
            complete solutions from concept to deployment. I&apos;m always
            looking forward to discussing how we can work together on exciting
            new projects.
          </p>
        </div>
                    ...
                    <Badge
                      ...
                      className={
                        project.status === 'Completed'
                          ? 'bg-primary text-primary-foreground shadow-[0_0_8px_rgba(0,255,65,0.3)]'
                          : ''
                      }
                    >
                      {project.status}
        ...
        <div className="mt-16 text-center">
          <div className="max-w-md mx-auto">
            ...
            >
              <a
                href="https://github.com/itsgarik"
                target="_blank"
                rel="noopener noreferrer"
              >
