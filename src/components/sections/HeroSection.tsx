...
import { ImageWithFallback } from 'src/components/context/ImageWithFallback'
          ...
          <div className="flex justify-center mb-8">
            <div className="relative">
              ...
              <div className="relative w-40 h-40 md:w-52 md:h-52 lg:w-60 lg:h-60 rounded-full overflow-hidden border-4 border-primary shadow-[0_0_20px_rgba(0,255,65,0.3)]">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1634133472760-e5c2bd346787?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHBvcnRyYWl0JTIwbWFsZSUyMGRldmVsb3BlcnxlbnwxfHx8fDE3NTUzNjk0NDZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                  alt="Garik - Full Stack Developer"
