            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {sports.map((sport, index) => {
                        // This is the key change: Assign the icon to a capitalized variable.
                        // JSX requires component names to be in PascalCase.
                            ...
                            >
                                <CardHeader className="text-center">
                                    <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4 shadow-[0_0_10px_rgba(0,255,65,0.2)]">
                                        {/* Now, we use the capitalized variable to render the icon */}
