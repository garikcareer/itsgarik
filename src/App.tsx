    ...
    return (
        ...
        >
            <div className="min-h-screen bg-background text-foreground relative overflow-x-hidden">
                ...
                <div
                    className="relative z-[2] min-h-screen md:mx-[clamp(80px,8vw,120px)] grid grid-rows-[auto_1fr_auto]">
                    ...
                    <main
                        className="main-content w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 relative z-[2]">
                        <div className="content-wrapper max-w-7xl mx-auto">
                            ...
                            <div className="space-y-0">
                                ...
                                <div
                                    className="py-16 md:py-20 lg:py-24 -mx-4 sm:-mx-6 md:-mx-8 lg:-mx-12 xl:-mx-16 2xl:-mx-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 bg-card/50">
